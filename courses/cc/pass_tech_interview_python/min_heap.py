#
# Example implementation of Min-Heap
#
...
if __name__ == '__main__':
  ...
  numbers = [n for n in range(10001, 1, -1)]

  # another example numbers
  numbers = [10, 13, 21, 61, 22, 23, 99]
  ...
  # Note: The seems not to be a complete implementation
  # Isn't there heapifying down missing?
